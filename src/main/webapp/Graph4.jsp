...
<body>
	<% 
	ReadAllFile allFile = new ReadAllFile();
	JSONArray data = allFile.getAllData();
	JSONArray link = allFile.getAllLink();
	JSONArray categories = allFile.getAllCate();
...
// 				backgroundColor: '#ccc',	// 背景颜色
			    ...
			    [{
			        ...
			        focusNodeAdjacency: true,   // 是否在鼠标移到节点上的时候突出显示节点以及节点的边和邻接节点。[ default: false ]
			            ...
			            edgeLength: [10, 5]      // [ default: 30 ]边的两个节点之间的距离(关系对象连接线两端对象的距离,会根据关系对象值得大小来判断距离的大小)，
